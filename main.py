...
# # Temporary fix for flask_gravatar's "_request_ctx_stack" error with Flask 2.3+
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, form=comment_form, year=year, current_user=current_user)
